...
add_cells_to_pblock [get_pblocks pblock_1] [get_cells -quiet [list {dsp_main_inst/dsp_gen[0].dsp_top_inst/bunch_fir_top_inst}]]
...
add_cells_to_pblock [get_pblocks pblock_2] [get_cells -quiet [list {dsp_main_inst/dsp_gen[1].dsp_top_inst/bunch_fir_top_inst}]]
